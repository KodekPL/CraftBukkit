...
public class ItemMonsterEgg extends Item {
    ...
    public static Entity a(World world, int i, double d0, double d1, double d2) {
        // CraftBukkit start
        return a(world, i, d0, d1, d2, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.SPAWNER_EGG);
    }

    public static Entity a(World world, int i, double d0, double d1, double d2, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason spawnReason) {
        // CraftBukkit end
